            ...
            <div className="container pt-5 pb-5" id="portfolio">
                                ...
                                portfolios.map(portfolio => (
                                    <div className="single-port pb-4 mb-4">
                                        ...
                                        <div className="portfolio-details p-3">
                                            ...
                                            <span className="me-1 sbg">{portfolio.tech1} - </span>
                                            <span className="me-1 sbg">{portfolio.tech2} - </span>
                                            <span className="me-1 sbg">{portfolio.tech3} - </span>
                                            <span className="me-1 sbg">{portfolio.tech4}</span>
                                        </div>
                                    </div>
                                ))
                            }
                ...
                <div className="row">
                    <div className="col-md-12 text-center">
                        <a href="https://github.com/heymahmud" target="_blank" rel="noreferrer noreferrer">
