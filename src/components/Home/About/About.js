            ...
            <div className="container pt-5 pb-5" id="about">
                ...
                <div className="row about">
                    <div className="col-md-6 about-content mt-5">
                        <p>Hello! I am Mostafa Mahmud, a passionate and Dedicated Frontend Developer. My journey began in 2019 when a good friend of mine introduced me to the world of web development. When we started learning HTML, I was immediately blown away by CSS!</p>
